...
TRADE_START_UTC = _int("TRADE_START_UTC", 0)    # 24h activo — explosion detector reemplaza el filtro horario
TRADE_END_UTC   = _int("TRADE_END_UTC",   24)   # 24h activo
...
# ── Explosion Detector (TTM Squeeze + volumen) ────────────────────────────────
# Detecta compresión de volatilidad resolviéndose en ruptura confirmada por
# volumen real — el "momento de explosión". Reemplaza el filtro de horario
# fijo: en vez de bloquear por hora del reloj, caza rupturas genuinas 24/7.
